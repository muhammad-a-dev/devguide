...
This page expands :ref:`news-entry` with concrete examples of when a
``NEWS`` entry is needed. See also :ref:`what-s-new-and-news-entries`.
...
These examples match the guidance already listed under
:ref:`news-entry` (documentation changes, test changes, and strictly
internal changes with no user-visible effects generally skip ``NEWS``).
